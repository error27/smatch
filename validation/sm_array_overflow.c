...
sm_array_overflow.c:26 options_write() error: buffer overflow 'b' 4 <= 4
sm_array_overflow.c:27 options_write() error: buffer overflow 'c' 4 <= 4
sm_array_overflow.c:28 options_write() error: buffer overflow 'd' 4 <= 4
