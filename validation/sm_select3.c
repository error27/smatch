 ...
 *
 * check-output-start
sm_select3.c:7 func(3) a = min-max
sm_select3.c:9 func(5) Test #1 a ? 1 : c
sm_select3.c:11 func(7) a = min-max
sm_select3.c:12 func(8) c = min-max
...
sm_select3.c:29 func(25) a = min-max
sm_select3.c:30 func(26) c = min-max
sm_select3.c:32 func(28) c = 0
sm_select3.c:34 func(30) a = min-max
sm_select3.c:37 func(33) Test #3 a ? b : 1
sm_select3.c:39 func(35) a = min-max
sm_select3.c:40 func(36) b = min-max
...
sm_select3.c:57 func(53) a = min-max
sm_select3.c:58 func(54) b = min-max
